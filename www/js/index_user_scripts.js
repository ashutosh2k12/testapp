	   ...
	   success: function(data) {
		...
		var pushes = data.pushes;
		 if(pushes.length>0){
			...
			{
			var pushj = $.parseJSON(pushes[i]);
			 _cont += '<li class="widget uib_w_list list-push push'+i+'" data-uib="app_framework/listitem" data-ver="0" data-push=\''+pushj+'\'>'+pushes[i].message+'</li>';
			}
